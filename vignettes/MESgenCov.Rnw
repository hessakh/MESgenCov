...
<<chunckCovMult,include=TRUE,eval=FALSE>>=
    g2 <-getCov(FALSE,"01/01/83 00:00", "12/31/88 00:00",TRUE,NULL,
...
g2<-getCov(FALSE,"01/01/83 00:00", "12/31/88 00:00",TRUE,c("OH71","NY08"),
           NULL,TRUE,"IN41SO4","SO4",FALSE,TRUE,"IN41",FALSE,FALSE,12,1,3,)
g2$rosnerTest
@
%%
...
<<chunckCovSiteOutremoved,include=TRUE,eval=FALSE>>=
  getCov(FALSE,"01/01/83 00:00", "12/31/86 00:00",TRUE,c("OH71","NY08"),
...
<<chunckCovPlotALL,include=TRUE,eval=FALSE>>=
  getCov(FALSE,"01/01/83 00:00", "12/31/86 00:00",TRUE,c("OH71","NY08"),
         c("OH71",1),TRUE,"OH71SO4","SO4",FALSE,FALSE,NULL,FALSE,FALSE,12,1,3)
@
...
<<chunkCovResult,include=TRUE,eval=TRUE>>=
  result <- getCov(FALSE,"01/01/83 00:00", "12/31/86 00:00",FALSE,
                   c("OH71", "NY08", "WV18", "MI53", "NH02"),NULL,
...
<<chunkCovMat,include=TRUE,eval=FALSE>>=
  result <- getCov(FALSE,"01/01/83 00:00", "12/31/86 00:00",FALSE,
                   c("OH71", "NY08", "WV18", "MI53", "NH02"),NULL,
                   FALSE,NULL,"SO4",FALSE,FALSE,NULL,FALSE,TRUE,12,1,3)
@
